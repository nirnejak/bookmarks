...
const RegisterForm: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <button
        type="submit"
        className="w-full rounded-md bg-slate-700 px-3.5 py-2 text-slate-100 text-sm focus:outline-0"
      >
        Register
      </button>
      <p className="mt-2 flex items-center gap-1 text-slate-500 text-sm">
        <Info size={14} />
